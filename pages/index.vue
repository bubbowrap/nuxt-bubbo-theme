<template>
  <main class="site-main c-homepage" role="main">
    <section class="homepage-hero container">
      <h1
        class="homepage-hero__title aos-init"
        data-aos="fade-up"
        data-aos-offset="200"
        data-aos-delay="100"
      >
        Hi, I’m <strong class="accent">Jeremy Samuel</strong>, and I’m a
        front-end designer. I design <span class="accent">+</span> animate
      ...
      <ul
        class="homepage-hero__social aos-init"
        data-aos="fade-up"
        data-aos-delay="200"
      >
        <li class="homepage-hero__social-item">
          <a
            ...
            aria-label="See my work on Codepen"
          >
            <span class="tooltiptext">My Codepen</span>
        ...
        <li class="homepage-hero__social-item">
          <a
            href="https://www.github.com/bubbowrap"
            class="homepage-hero__social-link tooltip"
            target="_blank"
            rel="noopener noreferrer"
            aria-label="See my work on Github"
          >
            <span class="tooltiptext">My Github</span>
            <svg viewBox="0 0 24 24">
              <path
                fill="#E6052A"
        ...
        <li class="homepage-hero__social-item">
          <a
            href="https://www.twitter.com/bubbowrap"
            class="homepage-hero__social-link tooltip"
            target="_blank"
            rel="noopener noreferrer"
            aria-label="Follow me on Twitter"
          >
            <span class="tooltiptext">My Twitter</span>
            <svg viewBox="0 0 24 24">
              <path
                fill="#E6052A"
        ...
        <li class="homepage-hero__social-item">
          <a
            href="https://www.linkedin.com/in/bubbowrap"
            class="homepage-hero__social-link tooltip"
            target="_blank"
            rel="noopener noreferrer"
            aria-label="Connect with me on LinkedIn"
          >
            <span class="tooltiptext">My LinkedIn</span>
            <svg viewBox="0 0 24 24">
              <path
                fill="#E6052A"
    ...
    >
      ...
      <div class="experience-box">
        ...
        <ul class="experience-box__list">
          <li class="experience-box__list-tem">
            Designed and developed modern-looking, high-converting landing
            pages, ads, and calls to action for in-house and client websites
            with HTML, WordPress, Twig, ACF, Sass, Javascript, and jQuery
          </li>
          <li class="experience-box__list-tem">
            Collaborated with writers, marketers, and other developers to
            produce new components and templates focused on improving the user
      ...
      <div class="experience-box">
        <div class="experience-box__header">
          <div>
            <h3 class="experience-box__title">Web Designer</h3>
            <h4 class="experience-box__company">NetSource Technologies</h4>
          </div>
          <div class="experience-box__date">November 2012 - March 2017</div>
        </div>
        <ul class="experience-box__list">
          <li class="experience-box__list-tem">
          ...
          <li class="experience-box__list-tem">
            Advised clients on identity and strategy; worked to understand
            client end goals and needs while also being an advocate for the end
            user
          </li>
          <li class="experience-box__list-tem">
      ...
      <div class="experience-box">
        <div class="experience-box__header">
          <div>
            <h3 class="experience-box__title">Production Intern</h3>
            <h4 class="experience-box__company">WCJB TV20</h4>
          </div>
          <div class="experience-box__date">March 2009 - April 2009</div>
        </div>
        <ul class="experience-box__list">
          <li class="experience-box__list-tem">
    ...
    >
      ...
      <div>
        <p>
          ...
          Whenever I see something cool or engaging I immediately need to know
          how it's done so that I can incorporate it into my own work, and
          that’s led to me learning a little bit about a lot of different
          things.
        </p>
        <p>
          I graduated from the
          <a href="https://scad.edu" target="_blank" rel="noopener"
        ...
        <div class="skills-lists">
          <div>
            <strong class="skills-lists__title"
    ...
    >
      ...
      <div>
        <p>
          Check out my
          <a href="https://www.codepen.io/bubbowrap">Codepen</a> and
          <a href="https://www.github.com/bubbowrap">Github</a> to see what I’m
          working on, or my
          <a href="https://www.twitter.com/bubbowrap">Twitter</a> to see what
          I’m up to. I’m always down to chat about code (or heck, just life in
          general), so send me an email and I’ll do my very best to get back to
          you!
        </p>
        <a href="mailto:hello@bubbowrap.com" class="btn btn--line"
          >Message Me</a
        >
      </div>
    </section>
